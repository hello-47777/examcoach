      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/wiki/guides/yki-writing-preparation-plan" className="text-blue-700 hover:underline">YKI Writing Preparation Plan: 30-Day Study Schedule for B1-B2</Link></li>
          </ul>
        </nav>
