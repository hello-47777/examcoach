...
export const metadata = {
  title: "Essential Informal Finnish Email Phrases for the YKI Test",
  description: "Boost your YKI vocabulary with our swipe file of essential informal Finnish email phrases. Master casual Finnish greetings, check-ins, and sign-offs.",
};
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      <article className="prose prose-lg max-w-none text-gray-800">
        ...
        <p>
          Once you have these phrases memorized, I highly recommend combining them with the Ultimate YKI Informal Email Template. Practicing these structures alongside a realistic YKI Test Informal Email Example will make you unstoppable on exam day!
        </p>
      </article>
