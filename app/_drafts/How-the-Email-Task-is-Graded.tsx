...
export const metadata = {
  title: "YKI Writing Informal Scoring: How the Email Task is Graded",
  description: "Understand YKI writing informal scoring and the YKI keskitaso assessment criteria. Learn exactly how examiners grade your email and what separates Level 3 from Level 4.",
};
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      <article className="prose prose-lg max-w-none text-gray-800">
        ...
        <p>
          To ensure you aim for the highest score possible, I recommend reviewing exactly how to write an informal email for the YKI test step-by-step. Additionally, familiarizing yourself with the 5 common YKI informal email mistakes will help you avoid the traps that commonly cost candidates their Level 4 rating.
        </p>
      </article>
