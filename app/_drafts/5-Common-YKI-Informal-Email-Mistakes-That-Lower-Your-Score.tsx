...
export const metadata = {
  title: "5 Common YKI Informal Email Mistakes That Lower Your Score",
  description: "Avoid the top YKI informal email mistakes that cause candidates to fail the YKI writing test. Learn how to fix these common Finnish email errors quickly.",
};
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      <article className="prose prose-lg max-w-none text-gray-800">
        ...
        <p>
          To ensure you don&apos;t fall into these traps, I highly recommend reading up on how YKI writing informal scoring is explained by experts. Furthermore, studying exactly how to write an informal email for the YKI test step-by-step will give you a reliable strategy to use on exam day.
        </p>
      </article>
